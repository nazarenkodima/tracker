...
module.exports = {"timer":"styles-m__timer---20axZ","name":"styles-m__name---Pfus2","time":"styles-m__time---1AQsY","actions":"styles-m__actions---1D1CU","isRunning":"styles-m__isRunning---2AXT6"};
...
// extracted by mini-css-extract-plugin
module.exports = {"tracker":"styles-m__tracker---1kuHo","submitButton":"styles-m__submitButton---12UQk"};
...
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(26);
...
/* harmony import */ var _Components_Layout_Layout__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(21);
/* harmony import */ var _Components_Logo_Logo__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(22);
/* harmony import */ var _Components_Tracker_Tracker__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(27);
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(App, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_Components_Layout_Layout__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"], null, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_Components_Logo_Logo__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"], null), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_Components_Tracker_Tracker__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"], null));
    }
  }]);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _styles_m_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(23);
...
var Logo = function Logo() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: _styles_m_css__WEBPACK_IMPORTED_MODULE_2___default.a.logo
  }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h1", null, "Tracker"));
}.bind(undefined);
...
// extracted by mini-css-extract-plugin
module.exports = {"logo":"styles-m__logo---2sxJY"};
...
// CONCATENATED MODULE: ./source/Components/Icons/RemoveCircle.js



var RemoveCircle_this = undefined;



var RemoveCircle_SvgRemoveCircle = function SvgRemoveCircle(props) {
  newArrowCheck_default()(this, RemoveCircle_this);

  return react_default.a.createElement("svg", extends_default()({
    width: 24,
    height: 24
...
/* harmony default export */ var RemoveCircle = (RemoveCircle_SvgRemoveCircle);
// CONCATENATED MODULE: ./source/Components/Icons/PauseCircle.js



var PauseCircle_this = undefined;



var PauseCircle_SvgPauseCircle = function SvgPauseCircle(props) {
  newArrowCheck_default()(this, PauseCircle_this);
...
/* harmony default export */ var PauseCircle = (PauseCircle_SvgPauseCircle);
// CONCATENATED MODULE: ./source/Components/Icons/PlayCircle.js



var PlayCircle_this = undefined;



var PlayCircle_SvgPlayCircle = function SvgPlayCircle(props) {
  newArrowCheck_default()(this, PlayCircle_this);
...
/* harmony default export */ var PlayCircle = (PlayCircle_SvgPlayCircle);
// EXTERNAL MODULE: ./source/Components/Timer/styles.m.css
var styles_m = __webpack_require__(11);
var styles_m_default = /*#__PURE__*/__webpack_require__.n(styles_m);

// CONCATENATED MODULE: ./source/Components/Timer/Timer.js
...
function (_Component) {
  ...
  function Timer() {
    ...
    _this = possibleConstructorReturn_default()(this, (_getPrototypeOf2 = getPrototypeOf_default()(Timer)).call.apply(_getPrototypeOf2, [this].concat(args)));

    defineProperty_default()(assertThisInitialized_default()(_this), "state", {
      time: moment_default()().utc().hours(0).minutes(0).seconds(0),
      tracker: {
        isRunning: JSON.parse(localStorage.getItem("Run".concat(_this.props.id)))
      }
    });

    defineProperty_default()(assertThisInitialized_default()(_this), "getTime", function () {
      newArrowCheck_default()(this, _this2);

      var timeStamp = _this.props.timeStamp;
      var now = moment_default.a.now();
      return now - timeStamp;
    }.bind(this));

    defineProperty_default()(assertThisInitialized_default()(_this), "handleTrackerTime", function () {
      var _this3 = this;

      newArrowCheck_default()(this, _this2);

      var updatedTrackerTime;
      var _this$state = _this.state,
          time = _this$state.time,
          isRunning = _this$state.tracker.isRunning;
      var id = _this.props.id;
      var trackerTime = JSON.parse(localStorage.getItem("tracker".concat(id)));

      if (trackerTime == null) {
        updatedTrackerTime = time;
      } else {
        updatedTrackerTime = moment_default()(trackerTime);
      }
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "saveTrackerToStorage", function () {
      var _this4 = this;
      ...
      var isRunning = JSON.parse(localStorage.getItem("Run".concat(id)));
      var tracker = {
        id: id,
        name: name,
        isRunning: isRunning,
      ...
      _this.setState({
        tracker: objectSpread_default()({}, _this.state.tracker, {
          tracker: tracker
        })
      });
      ...
      if (trackers.some(function (obj) {
        newArrowCheck_default()(this, _this4);

        return obj.id === tracker.id;
      }.bind(this))) {} else {
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "setIsRunningStatus", function (status) {
      newArrowCheck_default()(this, _this2);

      var isRunning = _this.state.tracker.isRunning;
      ...
      localStorage.setItem("Run".concat(_this.props.id), JSON.stringify(status));
    }.bind(this));

    defineProperty_default()(assertThisInitialized_default()(_this), "pauseTimer", function () {
      newArrowCheck_default()(this, _this2);
      ...
      _this.setIsRunningStatus(false);
    }.bind(this));
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "deleteTimer", function () {
      newArrowCheck_default()(this, _this2);

      var _this$props2 = _this.props,
          id = _this$props2.id,
          deleteTracker = _this$props2.deleteTracker;
      deleteTracker(id);
    }.bind(this));
  ...
  createClass_default()(Timer, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      ...
      if (prevState.tracker.isRunning !== this.state.tracker.isRunning) {
        localStorage.setItem("tracker".concat(id), JSON.stringify(time));
        this.handleTrackerTime();
      }
    }
  }, {
    ...
    value: function componentDidMount() {
      var id = this.props.id;
      var isRunning = this.state.tracker.isRunning;
      var timeLapse = this.getTime();

      if (isRunning) {
        localStorage.setItem("tracker".concat(id), JSON.stringify(timeLapse));
      }
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
          ...
          isRunning = _this$state2.tracker.isRunning;
      return react_default.a.createElement("li", {
        className: classnames_default()(styles_m_default.a.timer, defineProperty_default()({}, styles_m_default.a.isRunning, isRunning))
      }, react_default.a.createElement("div", {
        className: styles_m_default.a.name
      }, name), react_default.a.createElement("div", {
        className: styles_m_default.a.time
      }, moment_default()(time).utc().format(moment_default.a.HTML5_FMT.TIME_SECONDS)), react_default.a.createElement("div", {
        className: styles_m_default.a.actions
      }, isRunning ? react_default.a.createElement(PauseCircle, {
        onClick: this.pauseTimer
      }) : react_default.a.createElement(PlayCircle, {
        onClick: this.startTimer
      }), react_default.a.createElement(RemoveCircle, {
...
// CONCATENATED MODULE: ./source/Components/Icons/PlayArrow.js



var PlayArrow_this = undefined;



var PlayArrow_SvgPlayArrow = function SvgPlayArrow(props) {
  newArrowCheck_default()(this, PlayArrow_this);
...
/* harmony default export */ var PlayArrow = (PlayArrow_SvgPlayArrow);
// EXTERNAL MODULE: ./source/Components/Tracker/styles.m.css
var Tracker_styles_m = __webpack_require__(14);
var Tracker_styles_m_default = /*#__PURE__*/__webpack_require__.n(Tracker_styles_m);

// CONCATENATED MODULE: ./source/Components/Tracker/Tracker.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Tracker_Tracker; });
...
/*#__PURE__*/
function (_Component) {
  inherits_default()(Tracker, _Component);
  ...
  function Tracker() {
    ...
    _this = possibleConstructorReturn_default()(this, (_getPrototypeOf2 = getPrototypeOf_default()(Tracker)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "updateNewTrackerName", function (event) {
      newArrowCheck_default()(this, _this2);
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "handleFormSubmit", function (event) {
      newArrowCheck_default()(this, _this2);
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "createTracker", function () {
      var _this3 = this;

      var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : moment_default()().format(moment_default.a.HTML5_FMT.TIME_SECONDS);

      newArrowCheck_default()(this, _this2);

      var newTimerName = _this.state.newTimerName;
      ...
      var tracker = {
        name: name,
        id: uuid_default()(),
        timeStamp: moment_default.a.now()
      };

      _this.setState(function (_ref) {
        var trackers = _ref.trackers;

        newArrowCheck_default()(this, _this3);

        return {
          trackers: [tracker].concat(toConsumableArray_default()(trackers)),
          newTimerName: ''
        };
      }.bind(this));

      localStorage.setItem("Run".concat(tracker.id), JSON.stringify(true));
    }.bind(this));

    defineProperty_default()(assertThisInitialized_default()(_this), "deleteTracker", function (id) {
      var _this4 = this;

      newArrowCheck_default()(this, _this2);

      var trackers = _this.state.trackers;
      var newTrackers = trackers.filter(function (tracker) {
        newArrowCheck_default()(this, _this4);
  ...
  createClass_default()(Tracker, [{
    ...
    value: function componentDidMount() {
      ...
      var tracker = JSON.parse(localStorage.getItem('trackers'));

      if (tracker !== null) {
        this.setState(function (_ref2) {
          var trackers = _ref2.trackers;

          newArrowCheck_default()(this, _this5);

          return {
            trackers: [].concat(toConsumableArray_default()(tracker), toConsumableArray_default()(trackers))
          };
        }.bind(this));
      }
    }
    ...
    value: function render() {
      ...
      return react_default.a.createElement("main", {
        className: Tracker_styles_m_default.a.tracker
        ...
        type: "submit"
      }, react_default.a.createElement(PlayArrow, null)))), react_default.a.createElement("section", null, react_default.a.createElement("ul", null, trackersJSX)));
    }
  }]);
...
/* harmony import */ var _theme_init_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(33);
/* harmony import */ var _theme_init_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_theme_init_css__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _App_App__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(20);




Object(react_dom__WEBPACK_IMPORTED_MODULE_1__["render"])(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_App_App__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], null), document.getElementById('app'));
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(15),q=__webpack_require__(31);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));var ba=null,ca={};
